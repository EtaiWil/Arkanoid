...
public class TestForAss2 {
    ...
    private shapes.Point previousP = null;
    ...
    public void checkPoint() {
        shapes.Point p1 = new shapes.Point(3.5, 4.6);
        shapes.Point p2 = new shapes.Point(3.5, 4.6);
        shapes.Point p3 = new shapes.Point(5.4, 7.8);
        shapes.Point p4 = new shapes.Point(-5.4, 7.8);
        shapes.Point p5 = new shapes.Point(-5.4, -7.8);
        shapes.Point p6 = new shapes.Point(5.4, -7.8);
        shapes.Point p7 = new shapes.Point(0.0, 0.0);
        ...
        System.out.println("passed tests for shapes.Point");
    }


    public void checkLine() {
        Line f = new Line(49.45, 68.3, 93.23, 27.3);
        shapes.Point c1 = new shapes.Point(49.45, 68.3);
        shapes.Point c2 = new shapes.Point(93.23, 27.3);
        // is same as lf
...
//            shapes.Line t = new shapes.Line(136.24, 57.79,180.0, 80.04);
        ...
        shapes.Point t1 = new shapes.Point(100.0, 160.0);
        shapes.Point s1 = new shapes.Point(120.0, 160.0);
        shapes.Point r1 = new shapes.Point(1400.0, 160.0);
        ...
        assert (f.middle().equals(new shapes.Point(71.34, 47.8)));
...
//            assert (l3.intersectionWith(l15) == null);
        ...
        assert (n.intersectionWith(p).equals(new shapes.Point(40.0, 40.0)));
        assert (s.intersectionWith(g).equals(new shapes.Point(119.95907554822693, 49.521427043314844)));
        assert (f.intersectionWith(g).equals(new shapes.Point(87.242330580114, 32.907456514740204)));
        assert (a.intersectionWith(b).equals(new shapes.Point(0.0, 27.02660885723134)));

        //added tests
        assert (a.isIntersecting(j1));
        assert (a.intersectionWith(j1).equals(new shapes.Point(0.0, 0.0)));

        assert (k1.isIntersecting(j1));
        assert (k1.intersectionWith(j1).equals(new shapes.Point(120.0, 0.0)));

        assert (k1.isIntersecting(l1));
        assert (k1.intersectionWith(l1).equals(new shapes.Point(120.0, 6.666666666666657)));

        assert (j1.isIntersecting(l1));
        assert (j1.intersectionWith(l1).equals(new shapes.Point(130.0, 0.0)));

        assert (m1.isIntersecting(p));
        assert (m1.intersectionWith(p).equals(new shapes.Point(40.0, 40.0)));

        assert (n1.isIntersecting(i));
        assert (n1.intersectionWith(i).equals(new shapes.Point(20.0, 80.0)));


        System.out.println("passed tests for shapes.Line");
    ...
    public void checkVelocity() {
        ...
        shapes.Point p1 = new shapes.Point(3.5, 7.8);
        shapes.Point p2 = new shapes.Point(-3.5, 7.8);
        shapes.Point p3 = new shapes.Point(-3.5, -7.8);
        shapes.Point p4 = new shapes.Point(3.5, -7.8);

        assert (v1.applyToPoint(p1).equals(new shapes.Point(7.0, 14.5)));
        assert (v1.applyToPoint(p2).equals(new shapes.Point(0.0, 14.5)));
        assert (v1.applyToPoint(p3).equals(new shapes.Point(0.0, -1.1)));
        assert (v1.applyToPoint(p4).equals(new shapes.Point(7.0, -1.1)));

        assert (v2.applyToPoint(p1).equals(new Point(0.0, 14.5)));
        assert (v2.applyToPoint(p2).equals(new shapes.Point(-7.0, 14.5)));
        assert (v2.applyToPoint(p3).equals(new shapes.Point(-7.0, -1.1)));
        assert (v2.applyToPoint(p4).equals(new shapes.Point(0.0, -1.1)));

        assert (v3.applyToPoint(p1).equals(new shapes.Point(0.0, 1.1)));
        assert (v3.applyToPoint(p2).equals(new shapes.Point(-7.0, 1.1)));
        assert (v3.applyToPoint(p3).equals(new shapes.Point(-7.0, -14.5)));
        assert (v3.applyToPoint(p4).equals(new shapes.Point(0.0, -14.5)));

        assert (v4.applyToPoint(p1).equals(new shapes.Point(7.0, 1.1)));
        assert (v4.applyToPoint(p2).equals(new shapes.Point(0.0, 1.1)));
        assert (v4.applyToPoint(p3).equals(new shapes.Point(0.0, -14.5)));
        assert (v4.applyToPoint(p4).equals(new shapes.Point(7.0, -14.5)));

        assert (v5.applyToPoint(p1).equals(new shapes.Point(3.5, 7.8)));
        assert (v5.applyToPoint(p2).equals(new shapes.Point(-3.5, 7.8)));
        assert (v5.applyToPoint(p3).equals(new shapes.Point(-3.5, -7.8)));
        assert (v5.applyToPoint(p4).equals(new shapes.Point(3.5, -7.8)));

//         shapes.Point p4 = new shapes.Point(3.5, -7.8);
        assert (v6.applyToPoint(p4).equals(new shapes.Point(8.9, -7.8)));
//        assert (v7.applyToPoint(p4).equals(new shapes.Point(3.5, -2.4)));
        assert (v7.applyToPoint(p4).equals(new shapes.Point(3.5, -13.2)));
//        assert (v8.applyToPoint(p4).equals(new shapes.Point(((6.0 * Math.sin(Math.PI/6)))
//                + 3.5, (6.0 * Math.sin(Math.PI / 3)) -7.8)));
        assert (v8.applyToPoint(p4).equals(new shapes.Point(((6.0 * Math.sin(Math.PI / 6)))
                + 3.5, -(6.0 * Math.sin(Math.PI / 3)) - 7.8)));

        System.out.println("passed tests for collidable.Velocity");
    ...
    public void checkBall() {
        shapes.Point c1 = new shapes.Point(50.5, 60.3);
        shapes.Point c2 = new shapes.Point(0.0, 0.0);
        shapes.Point c3 = new shapes.Point(-90.8, 130.5);
        shapes.Point c4 = new shapes.Point(-90.8, -130.5);
        shapes.Point c5 = new shapes.Point(90.8, -130.5);
        shapes.Point c6 = new shapes.Point(90.8, 130.5);
        shapes.Point c7 = new shapes.Point(150.0, 150.0);
        shapes.Point c8 = new shapes.Point(100.0, 100.0);
...
//            g.show(t);
        ...
        System.out.println("passed tests for sprite.Ball");
    ...
    public void checkBallCoords(Ball b) {
        ...
        this.previousP = new shapes.Point(b.getX(), b.getY());
    }
...
/*
    public static void main(String[] args) {
        assTwo.TestForAss2 assTwo.test = new assTwo.TestForAss2();
         assTwo.test.checkPoint();

        assTwo.test.checkLine();



        assTwo.test.checkVelocity();
       // assTwo.test.checkBall();
